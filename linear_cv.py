...
def baseline_model():
    ...
    model.compile(loss='mean_squared_error', optimizer='adam', metrics=['accuracy', r_squre_error])
    #model.compile(loss='mean_squared_error', optimizer='sgd', metrics=['accuracy', r_squre_error])
